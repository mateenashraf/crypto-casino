...
(function () {
  ...
  // Default OFF (3 free spins/day). One-time clear of the old auto-on default.
  if (SecureStorage.getRaw(UNLIMITED_KEY) == null) {
    SecureStorage.setRaw(UNLIMITED_KEY, '0');
  }
  if (SecureStorage.getRaw('dev_unlimited_migrated') !== '1') {
    SecureStorage.setRaw(UNLIMITED_KEY, '0');
    SecureStorage.setRaw('dev_unlimited_migrated', '1');
  }
